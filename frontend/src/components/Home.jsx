...
//         formData.append("file",selctedFile);
//         try
//         {
...
//             <span className="text-3xl mr-2">{selctedFile?selctedFile.name:"Choose File"}</span>
//                 </label>
//                 <button 
//                 onClick={handleSubmit}
//                 disabled={!selctedFile} className="text-white bg-blue-500 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-4 py-2 rounded-lg">convert file</button>
//             </div>
//             </div>
//         </div>
//     </div>
